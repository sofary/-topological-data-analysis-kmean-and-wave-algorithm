...
//
#include "Wave.h"
//функция расстояний между 2 точками
...
//функция создает матрицу расстояний между элементами
...
//функция для создания бинарной матрицы
//поджоги, пороги расстояния
...
//функция сохраняет кластеризованные данные
//в файл для gnuplot
void Wave::print_clusters(ofstream &out,string filename) {
    ...
    out_gnu << "plot 'D:/CodeTime/TDA_Arkhipova/cmake-build-debug/" + filename +
               "' using 1:2:(rgb($3,$4,$5))  notitle with points lc rgb variable, ";
    out_gnu
            << " 'D:/CodeTime/TDA_Arkhipova/cmake-build-debug/"+arrow_name+"' using 1:2:3:4 with vectors head filled  lw 2  lc rgb \"red\"";
    out.open(filename);
